package com.conflux.mpesa.reconcilation.upload.api;
...
import com.conflux.mpesa.reconcilation.upload.service.UploadWritePlatformService;
...
@Component
@Scope("singleton")
public final class UploadApiResource {
